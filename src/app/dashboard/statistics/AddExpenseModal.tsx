...
import { X, Minus, Calendar } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { ExpenseCategory, EXPENSE_CATEGORY_LABELS } from '../../../../types/finance';
...
// Tax is recorded via the dedicated tax flow, so it is not offered here.
const SELECTABLE: ExpenseCategory[] = ['server', 'materials', 'salary', 'rent', 'other'];
